<div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="mb-4">
                    <a href="http://localhost:8080/ulasan/add" class="button-pale-iris">Tambah data</a>
                </div>
                ...
                <tbody>
                    <?php if ($_SESSION['level'] != 'Peminjam') { ?>
                      ...
                      <?php } else { ?>
                          <?php $no = 1; ?>
                          <?php foreach ($model['datas'] as $ulasan) { ?>
                          <tr>
                              <th scope="row"><?php echo $no++; ?></th>
                              <td><?php echo $ulasan->username; ?></td>
                              <td><?php echo $ulasan->title; ?></td>
                              <td><?php echo $ulasan->text; ?></td>
                              <td><?php for ($i = 1; $i <= $ulasan->rating; $i++ ) {
                            echo '&#9733;';
                        } ?></td>
                              <td>
                                  <a href="http://localhost:8080/ulasan/update/<?php echo $ulasan->id ?>" class="button-amber" style="padding: 4px 5px;"><i class="fa-solid fa-pen"></i></a>
                                  <a href="http://localhost:8080/ulasan/delete/<?php echo $ulasan->id ?>" class="button-rose" style="padding: 4px 5px;"><i class="fa-solid fa-trash"></i></a>
                              </td>
                          </tr>
                          <?php } ?>
                      <?php } ?>
                    ...
                    <?php if ($_SESSION['level'] == 'Peminjam') { ?>
                      ...
                      <?php } else { ?>
                          <?php $no = 1; ?>
                          <?php foreach ($model['data'] as $ulasan) { ?>
                          <tr>
                              <th scope="row"><?php echo $no++; ?></th>
                              <td><?php echo $ulasan->username; ?></td>
                              <td><?php echo $ulasan->title; ?></td>
                            ...
                            echo '&#9733;';
                              ...
                              <td>
                                  <a href="http://localhost:8080/ulasan/update/<?php echo $ulasan->id ?>" class="btn btn-sm btn-warning text-white"><i class="fa-solid fa-pen"></i></a>
                                  <a href="http://localhost:8080/ulasan/delete/<?php echo $ulasan->id ?>" class="btn btn-sm btn-danger"><i class="fa-solid fa-trash"></i></a>
                              </td>
                          </tr>
                          <?php } ?>
                      <?php } ?>
