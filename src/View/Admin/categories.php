<div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <h1><?= $model['title'] ?? 'Daftar Category' ?></h1>
                <div class="mb-4">
                    <a href="http://localhost:8080/category/add" class="button-pale-iris">Tambah data</a>
                </div>
                  ...
                  <thead class="table-primary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="http://localhost:8080/category/update/<?php echo $category->id ?>" class="button-amber" style="padding: 4px 5px;"><i class="fa-solid fa-pen"></i></a>
                                <a href="http://localhost:8080/category/delete/<?php echo $category->id ?>" class="button-rose" style="padding: 4px 5px;"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
